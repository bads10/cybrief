...
app.post('/admin/sources/seed', adminAuth, async (req, res) => {
  const CYBER_SOURCES = [
    { name: 'CERT-FR Avis',             url: 'https://www.cert.ssi.gouv.fr/avis/feed/',                        category: 'CERT' },
    { name: 'CERT-FR Alertes',          url: 'https://www.cert.ssi.gouv.fr/alerte/feed/',                      category: 'CERT' },
    { name: 'CERT-FR Actualités',       url: 'https://www.cert.ssi.gouv.fr/actualite/feed/',                   category: 'CERT' },
    { name: 'IT-Connect',               url: 'https://www.it-connect.fr/feed/',                                category: 'News' },
    { name: 'ZATAZ',                    url: 'https://www.zataz.com/feed/',                                    category: 'News' },
    { name: 'Cisco Talos',              url: 'https://feeds.feedburner.com/feedburner/Talos',                  category: 'ThreatIntel' },
    ...
    { name: 'Sophos Naked Security',    url: 'https://news.sophos.com/feed/',                                 category: 'News' },
